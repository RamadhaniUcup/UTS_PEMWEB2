                ...
                <div className="min-h-screen py-16 px-4">
                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                        {workshopJadwal.map((jadwal, index) => (
                            <div
                            key={index}
                            className="bg-white rounded-lg shadow-md p-6 border-l-4 border-[#802D43]"
                            >
                                <div className="flex items-start gap-4">
                                    <jadwal.icon className="w-8 h-8 text-[#802D43] mt-1" />
                                    <div className="flex-1">
                                        <h3 className="text-xl font-bold text-[#802D43] mb-3">{jadwal.title}</h3>
                                        <div className="space-y-2 text-gray-600">
                                            <p className="flex items-center gap-2"><span className="font-semibold">Tanggal:</span> {jadwal.date}</p>
                                            <p className="flex items-center gap-2"><span className="font-semibold">Waktu:</span> {jadwal.time}</p>
                                            <p className="flex items-center gap-2"><span className="font-semibold">Lokasi:</span> {jadwal.location}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
