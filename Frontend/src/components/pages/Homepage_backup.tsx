...
import SpeakerCard from '../ui/SpeakerCard.tsx';
      ...
      <div className='max-w-7xl mx-auto px-6 py-2'>
        ...
        <section id='cards'>
          <div className='w-full'>
            <div>
              <h1 className='text-5xl  text-red-800  mb-6 font-semibold'>Tentang IVOFEST</h1>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-10 px-3 py-24'>
              {cardItems.map((item, index) => (
                <div key={index} className='w-full flex flex-col h-full border p-6 rounded-lg'>
                  <h3 className='text-2xl text-red-800 font-bold'>{item.title}</h3>
        ...
        <section id='speaker' className='py-24'>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-10 px-3 w-full'>
            {speakers.map((speaker, index) => (
              <SpeakerCard key={index} name={speaker.name} role={speaker.role} imageUrl={speaker.imageUrl} />
            ))}
          </div>
        </section>

        <section id='seminar' className='py-10 flex gap-10 justify-between items-center'>
          <div className='w-1/3'>
            <img src="https://www.invofest-harkatnegeri.com/assets/Maskot-Seminar.png" alt="" />
          </div>
          <div className='w-2/3 flex flex-col gap-6'>
        ...
        <section id='talkshow' className='py-10 flex gap-10 justify-between items-center'>
          <div className='w-2/3 flex flex-col gap-6'>
          ...
          <div className='w-1/3'>
            <img src="https://www.invofest-harkatnegeri.com/assets/Maskot-Talkshow.png" alt="" />
          </div>
        </section>

        <section id='workshop' className='py-10 flex gap-10 justify-between items-center'>
          <div className='w-1/2'>
            <img src="https://www.invofest-harkatnegeri.com/assets/Maskot-Workshop.png" alt="" />
          </div>
          <div className='w-2/3 flex flex-col gap-6'>
        ...
        <section id='competition' className='bg-red-50 w-full py-10'>
          <div className='max-w-7xl mx-auto px-6 flex flex-col md:flex-row gap-10 justify-between items-center w-full'>
            ...
            <div className='w-2/3'>
              <img src="https://www.invofest-harkatnegeri.com/assets/Maskot-Lomba.png" alt="" />
            </div>
          </div>
        </section>

        <section id='collapse' className='py-24'>
          <div className='w-full mx-auto mt-4'>
            ...
            <div className='py-24 grid grid-cols-1 md:grid-cols-2 gap-6 px-3 items-start'>
              {collapseItem.map((item, index) => (
                <Collapse key={index} title={item.title} description={item.description} icon={ChevronDown} />
              ))}
            </div>
          </div>
        </section>
