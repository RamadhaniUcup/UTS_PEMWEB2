        ...
        <div className="min-h-screen">
            ...
            <section id="deskripsi">
                <div className="max-w-7xl mx-auto py-20">
                    <div className="flex flex-col justify-center items-center gap-6 max-w-5xl mx-auto px-6">
                        <h1 className="font-semibold text-3xl text-center text-red-800">Tentang IT SEMINAR</h1>
            ...
            <section id="card">
                <div className="max-w-7xl mx-auto py-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 p-3 w-full">
            ...
            <section>
                <div>
                    {/* Menambahkan flex, items-center, dan gap-3 untuk jarak antar teks */}
                    <div className='h-fit mt-16 flex flex-col antialiased bg-white items-center justify-center relative overflow-hidden'>
                        <h1 className='text-4xl font-semibold flex items-center gap-3'>
                            Sponsor
                            <span className='font-bold text-red-900'>INVOVEST 2025</span>
                        </h1>
                    </div>
